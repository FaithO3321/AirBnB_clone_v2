...
class test_inherit_basemodel(unittest.TestCase):
    ...
    def test_instance(self):
        """check if at all user is an instance of BaseModel"""
        user = Amenity()
...
class test_Amenity_BaseModel(unittest.TestCase):
    ...
    def test_save_method(self, mock_storage):
        """Tests save method and if it update"""
        instance5 = Amenity()
...
class TestAmenity(unittest.TestCase):
    ...
    def test_to_dict_values(self):
        """test the values in dict returned from to_dict are correct"""
    ...
    def test_str(self):
        """test ifthe str method has the correct output"""
        amenity = Amenity()
